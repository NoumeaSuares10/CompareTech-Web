		...
		<h1><a href="index.html"><p style="color:white; font-size: 70px;">CompareTech</p></a></h1>
			<div id="menu">
				<ul>
					...
					<li><a href="form.php"  title="">Add phone(For manufacturer only)</a></li>					
				</ul>
			</div>
		</div>
...
<div id="coloumn8" class="column8">
	...
	<p><button class=button onclick="myFunction1()">Add Realme to compare</button><button class=button onclick="myFunction3()">Add iPhone 12 to compare</button><button class=button   onclick="myFunction2()">Add Oneplus Nord to compare</button><button class=button   onclick="myFunction4()">new phones that are added </button></p>
		<ul class="contact">
