...
<div id="coloumn8" class="column8">
	...
	<p><button class=button	onclick="myFunction1()">Add Samsung Galaxy s20 to compare</button><button class=button  onclick="myFunction3()">Add iPhone 12 to compare</button><button class=button   onclick="myFunction2()">Add Oneplus Nord to compare</button><button class=button   onclick="myFunction4()">new phones that are added </button></p>
		<ul class="contact">
